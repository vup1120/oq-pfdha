...
| `surface_rupture_depth_tolerance_km` | float | `0.01` | No | Depth tolerance of the surface-rupturing test: ruptures whose minimum depth exceeds it are treated as buried and contribute no displacement hazard. |
